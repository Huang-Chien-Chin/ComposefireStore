package tw.edu.pu.csim.s1120326.composefirestore
...
import tw.edu.pu.csim.s1120326.composefirestore.ui.theme.ComposefireStoreTheme
...
fun Birth(m: Modifier){
    var userName by remember { mutableStateOf("黃千津")}
